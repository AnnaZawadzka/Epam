...
public class FOH {
	...
	public void chooseFlight(String outbound, String inbound, String outDate, String backDate) {
		WaitHelpers.visibilityOfElementLocated(driver, popupLogged);
		WaitHelpers.invisibilityOfElementLocated(driver, popupLogged);
